...
- **🛒 Система чекбоксов** — интерактивный магазин с выбором позиций и количества
...
### 🛒 Система чекбоксов
- Интерактивный выбор товаров с чекбоксами (☐/✅)
- Управление количеством с помощью кнопок ➕/➖
- Категории товаров (пицца, бургеры, напитки, десерты)
- Корзина с подсчетом общей стоимости
- Оформление заказов с номером
